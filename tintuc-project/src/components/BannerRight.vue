                            ...
                            <div class="widget">
                                ...
                                <div class="trend-videos">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><router-link to="/BodyItem">We prepared the best 10 laptop
                                                    presentations for you</router-link></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                    ...
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><router-link to="/BodyItem">We are guests of ABC Design Studio -
                                                    Vlog</router-link></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                    ...
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><router-link to="/BodyItem">Both blood pressure monitor and
                                                    intelligent clock</router-link></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end videos -->
                            </div><!-- end widget -->
